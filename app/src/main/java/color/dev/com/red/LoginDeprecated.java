...
public class LoginDeprecated extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String uid = lee("USUARIO", "", LoginDeprecated.this);
        String ucl = lee("CLAVE", "", LoginDeprecated.this);
        if (ucl.length() > 0) {
            try {
    ...
    void WEB() {
        ...
        if (false) {
            ...
            i2.setClass(LoginDeprecated.this, Web.class);
            i2.putExtra("URL", url);
            i2.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            LoginDeprecated.this.startActivity(i2);
        }
    }
    ...
    void POLITICA() {
        ...
        Intent i2 = new Intent();
        i2.setClass(LoginDeprecated.this, Politica.class);
        i2.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        LoginDeprecated.this.startActivity(i2);
    ...
    void INFORMACION() {
        ...
        Intent i2 = new Intent();
        i2.setClass(LoginDeprecated.this, Informacion.class);
        i2.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        LoginDeprecated.this.startActivity(i2);
    ...
    void LICENCIA() {
        ...
        Intent i2 = new Intent();
        i2.setClass(LoginDeprecated.this, Licencia.class);
        i2.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        LoginDeprecated.this.startActivity(i2);
        ...
        if (user.getText().length() > 0 && contra.getText().length() > 0) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    if (modo_offline) {
                        lista = Subject.LEE("MATERIAS", LoginDeprecated.this);
                        offline = true;
                    } else {
                        ...
                        try {
                            ...
                            if (login != null) {
                                ...
                                if (recuerda.isChecked()) {
                                    guarda("USUARIO", usuario, LoginDeprecated.this);
                                    guarda("CLAVE", ENCRIPTA(contrase, usuario), LoginDeprecated.this);
                                }
    ...
    void INICIAR(ArrayList<Subject> lista, Faitic faitic, boolean offline) {
        ...
        Subject.GUARDA("MATERIAS", lista, LoginDeprecated.this);

        Intent i2 = new Intent();
        i2.setClass(LoginDeprecated.this, Materias.class);
        i2.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
